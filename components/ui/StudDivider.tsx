 ...
 * bordes con un corazón chico centrado — lectura clara de simple adorno, no
...
export function StudDivider() {
    return (
        <div aria-hidden="true" className="relative h-px my-3 bg-gradient-to-r from-transparent via-[var(--color-border)] to-transparent">
            <HeartIcon className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-4 h-4 text-[var(--color-accent)] bg-[var(--color-ink)]" />
        </div>
    );
}
