/** Corazón decorativo con un pequeño rulo en cada lóbulo — el motivo que se
 * repite en el visor de fotos y en los separadores, en vez de flechas o
 * diamantes lisos. Se dibuja como trazo (no relleno) para que combine con
 * cualquier color de acento vía `currentColor`. */
